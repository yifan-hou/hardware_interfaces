...
double buffToDouble(uint8_t *buff) {
  ...
  // You can use the following code to check whether your system is little
  // endian or not:
  //      unsigned int i = 1;
  //      char *c = (char*)&i;
  //      if (*c)
...
int main(int argc, char const *argv[]) {
   ...
   * Send joint
   */
  // float joint_command_deg[6] = {94.28, -81.68, 119.96, -129.11, 275.54,
  // -0.0}; float joint_command_rad[6]; for (int i = 0; i < 6; ++i)
  // joint_command_rad[i] = joint_command_deg[i]*PIf/180.0f;
